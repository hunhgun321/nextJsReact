...
export default function CastleIn2D() {
  ...
  return (
    <div style={{ position: 'relative', width: '95vw', height: '95vh', overflow: 'hidden', backgroundColor: 'black' }}>
      <Image
        src={"/disneyland_castle_png_best.png"}
        alt="Disneyland Castle"
        // This makes the image cover the entire div
        style={{ objectFit: 'contain', overflow: 'hidden' }} // This maintains aspect ratio
        fill={true}
      />
    </div>
  );
